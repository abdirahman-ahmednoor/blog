...
class TestReview(unittest.TestCase):
    ...
    def setUp(self):
         self.user_blade = User(username = 'blade',password = 'maziwa', email = 'abdirahman.noor@student.moringaschool.com')
    ...
    def test_check_instance_variables(self):
        ...
        self.assertEqual(self.new_review.user, self.user_blade)
